<template>
  <div>
    ...
    <el-table :data="tableData" :key="tableData.id" style="width: 100%" stripe>
      ...
      <el-table-column prop="company_name" label="成交价格"> </el-table-column>
  ...
  methods: {
    ...
    async search() {
      ...
      if (res.success) {
        ...
        this.$message.success("查询到" + this.purchaseList.length + "条数据");
        this.handleList();
      } else {
